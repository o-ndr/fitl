...
@section ('title', 'Presentations of the following track: ' . $track->track_name)
...
<div class="row">
	<div class="col-sm-9">
		...
		<div class="page-header">
			...
			<h1>Presentation track: {{ $track->track_name }}</h1>
		</div>

		<div class="list-group">
			@foreach ($track->presentations as $presentation)
